...
function crearClasePersona() {
  class Persona {
    ...
    getFriends() {
      ...
      var nAmigos = this.amigos.map(function(element) {
    ...
    getPromedioEdad() {
      ...
      //  return element[this.edad];
      //})
      //var suma = edades.reduce(function(acc, elemento){
      //  return acc + elemento;
      //})
      ...
      var suma = edades.reduce(function(acc, elementb) {
        return acc + elementb;
      })
